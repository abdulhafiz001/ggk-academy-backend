    ...
    <style>
        ...
        * {
        ...
        .header {
            ...
            margin-bottom: 15px;
            padding-bottom: 12px;
            border-bottom: 3px solid #028afe;
        }
        .logo-container {
            margin-bottom: 8px;
        }
...
<body>
    ...
    <div class="watermark">
        <div class="watermark-content">
            @php
                $logoPath = public_path('images/ggk-academy.jpeg');
    ...
    <div class="header">
        <div class="logo-container">
            ...
            @else
                <div style="width: 80px; height: 80px; background: #028afe; border-radius: 50%; margin: 0 auto; display: flex; align-items: center; justify-content: center; color: white; font-weight: bold; font-size: 14px;">GGKA</div>
            @endif
        </div>
